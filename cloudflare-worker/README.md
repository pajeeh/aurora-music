...
5. Defina essa URL nas variables `VITE_CONNECT_ENDPOINT` e `VITE_NOW_PLAYING_ENDPOINT` do repositório `pajeeh/aurora-music`.
...
7. Valide `/health`, Connect entre dois navegadores, `/now-playing.svg` e uma tentativa de publicação com outra conta.
