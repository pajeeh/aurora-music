...
export function renderSvg(data = {}, now = Date.now()) {
  ...
  <g clip-path="url(#frame)">
    ...
    <g transform="rotate(-4 700 54)" filter="url(#rough)"><rect x="548" y="28" width="302" height="48" fill="#f1eedf"/><text x="570" y="59" fill="#0a0a0e" font-family="Arial Black,Impact,sans-serif" font-size="21" font-weight="900" letter-spacing="1.7">NOISE IS A FEATURE</text></g>
    ...
    <g font-family="Arial,Helvetica,sans-serif">
      ...
      <g transform="translate(282 59) rotate(-1)"><path d="M0 3L${live ? 205 : 156} 0l7 31L5 34Z" fill="${live ? '#d8ff3e' : '#f1eedf'}"/><text x="17" y="23" fill="#09090d" font-family="Arial Black,Impact,sans-serif" font-size="12" font-weight="900" letter-spacing="1.5">${status}</text>${live ? '<circle cx="191" cy="16" r="5" fill="#ff4fc8"/><circle class="live-pulse" cx="191" cy="16" r="5" fill="none" stroke="#ff4fc8" stroke-width="2"/>' : ''}</g>
